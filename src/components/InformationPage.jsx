    ...
    return (
        <>
            <section className="shadow-md p-0 xl:p-2 w-full rounded-md flex flex-col xl:flex-row overflow-hidden">
                <div className="bg-blue-800 rounded-md w-full border-r-[1px] xl:border-b-[1px] border-gray-400 xl:w-[295px] h-[300px] px-4 xl:h-[300px] flex flex-col justify-center gap-5 items-center">
                ...
                <div className="bg-blue-800 rounded-md w-full xl:w-[295px] h-[300px] xl:h-[300px] flex flex-col justify-center gap-5 items-center px-4">
